...
import { FaUser, FaMapMarkerAlt, FaPhone, FaTimes } from "react-icons/fa";
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm mt-1">Add a town contact</p>
              </div>
            </div>
        ...
        <div className="p-8 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-600"
              value={form.name}
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              onClick={submit}
              disabled={loading}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-semibold rounded-xl disabled:opacity-50"
            >
