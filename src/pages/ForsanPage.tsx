...
export default function ForsanPage() {
  ...
  const isForsanPresident = () => {
    return (
      loggedInUser?.roles?.some(
        (r: any) => r.role_id === 4 && r.section_id === forsan_SECTION_ID,
      ) || loggedInUser?.is_global_admin
    );
  };

  const canManage = isForsanPresident();
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
            <div className="flex-1 w-full">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-base sm:text-lg shadow-lg">
              ...
              {activeRoles.map((r) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2 bg-gradient-to-r from-blue-50 to-indigo-50 px-3 sm:px-4 py-2 rounded-lg border border-blue-100 w-full">
                      {r.role_id === 4 ? (
                  ...
                  <>
                    <div className="relative">
                      <button
                        ...
                        className="w-full sm:w-auto border-2 border-gray-200 px-4 py-2 rounded-lg text-sm font-medium hover:border-blue-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all cursor-pointer bg-white flex items-center justify-between gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                            ...
                            <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-2xl border-2 border-gray-100 z-20 max-h-96 overflow-y-auto">
                              ...
                              {availableRoles.map((role) => (
                                <button
                                  ...
                                  className="w-full text-left px-4 py-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-colors border-b border-gray-50 last:border-0"
                                >
